...
/**
 * @title  CarveRenderer
 * @notice A contract that renders CarveGenerative tokens.
 */
contract CarveRenderer {
    ...
    function tokenURI(string memory tokenName, uint256 tokenId, string memory tokenBaseURI)
        public
        view
        returns (string memory)
    {
    ...
    function setRenderOfTokenId(uint256 tokenId, bool renderOffChain) external onlyController {
